...
Follow up for problem "Populating Next Right Pointers in Each Node".
        ...
        What if the given datastructure.tree could be any binary datastructure.tree? Would your previous solution still work?

        Note:

        You may only use constant extra space.
        For example,
        Given the following binary datastructure.tree,
        1
        /  \
        2    3
        / \    \
