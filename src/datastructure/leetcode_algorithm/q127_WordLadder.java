...
Given two words (beginWord and endWordWord), and a wordListionary's word datastructure.list, find the length of shortest transformation sequence from beginWord to endWordWord, such that:
        ...
        You may assume no duplicates in the word datastructure.list.
