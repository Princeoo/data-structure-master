...
/**
 * Given a sorted linked datastructure.list, delete all nodes that have duplicate numbers, leaving only distinct numbers from the original datastructure.list.
 * <p>
 * For example,
