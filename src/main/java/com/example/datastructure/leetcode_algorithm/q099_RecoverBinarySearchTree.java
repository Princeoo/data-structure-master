...
/**
 * Two elements of a binary datastructure.search datastructure.tree (BST) are swapped by mistake.
 * <p>
 * Recover the datastructure.tree without changing its structure.
 * <p>
 * Note:
