...
/**
Given an datastructure.array S of n integers, are there elements a, b, c, and d in S such that a + b + c + d = target?
 Find all unique quadruplets in the datastructure.array which gives the sum of target.
