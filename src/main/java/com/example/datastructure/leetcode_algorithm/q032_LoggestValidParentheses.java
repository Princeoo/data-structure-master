...
public class q032_LoggestValidParentheses {
    ...
    /**
        Given a datastructure.string containing just the characters '(' and ')', find the length of the longest valid (well-formed) parentheses substring.
    ...
    */
     ...
     *
         * And the DP idea is :
         ...
         If s[i] is '(', set longest[i] to 0,because any datastructure.string end with '(' cannot be a valid one.
         ...
         For example, input "()(())", at i = 5, longest datastructure.array is [0,2,0,0,2,0], longest[5] = longest[4] + 2 + longest[1] = 6.
     * @param s
     * @return
     */
